    ...
    <body>
        ...
        <?php
            ...
            if($_SESSION[admin] == null)
            {
                ...
                echo "Please authentificate yourself&nbsp;<a href = \"login.php\">here </a>";
                echo "</div>";
                exit();
            }
        ...
        <?php
            ...
            foreach( array_values($_SESSION[edit]) as $value )
            {
                ...
                echo "<button class=\"remove\" onclick=\"remove_link($id)\" id=\"remove_$id\">delete</button>\n";
                echo "<br>\n";
                echo "</div>";
                echo "</div>";
                $id++;
            ...
            echo "</div>\n";
            echo "<div class=\"justified\"\n>";
            echo "<button class=\"add\" onclick=\"append_link()\">+</button>\n";
            echo "</div>\n";
            echo "<div class=\"justified\">\n";
            echo "<button class=\"submit\" onclick=\"post_changes()\">Validate changes.</button>\n";
            echo "</div>\n";
            echo "<form method = \"POST\" action = \"manage.php?reset=1\">\n";
            echo "<div class=\"justified\">\n";
            echo "<input type=\"submit\" value=\"Reset changes\" ID=\"reset\">\n";
            echo "</div>\n";
            echo "</form>\n";
            echo "<form method = \"POST\" action = \"manage.php?deleteall=1\">\n";
            echo "<div class=\"justified\">\n";
            echo "<input class=\"removebutton\" type=\"submit\" value=\"Delete all links\" ID=\"deleteall\">\n";
            echo "</div>\n";
            echo "</form>\n";
            echo "<script language=\"JavaScript\" type=\"text/javascript\" src=\"scripts/manage.js\"></script>";
        ?>
        <?php
            if($_GET[validate])
            {
